                                        ...
                                        '<div class="form-group form-horizontal" style="margin-top:-10px;">'+
                                            ...
                                            '<div class=" ">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                   '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left " for="para">Para</label>'+
                                            ...
                                            '<div class=" ">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                   '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left " for="living">Living</label>'+
                                            ...
                                            '<div class=" ">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left" for="marriedlife">Married Life</label>'+
                                            ...
                                            '<div class=" ">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left " for="bloodgroup">Blood Group</label>'+
                                            ...
                                            '<div class=" ">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left " for="gestationalage">Gestational Age</label>'+
                                            ...
                                            '<div class="" >'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left " for="lastdeliverydate">Last Delivery Date</label>'+
                                            ...
                                            '<div class=" ">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+        
                                                    '<label class="  pull-left col-sm-4 dd_pd_0 dd_font_left " for="expecteddeliverydate">Expected Delivery Date</label>'+
                                ...
                                '<div class="panel-body" style="padding-top:15px;">'+
                                    '<div class="col-sm-12">'+
                                        ...
                                        '<div class="form-group form-horizontal" style="margin-top:-10px;">'+
                                            '<div class="">'+
                                                '<div class="col-sm-12 dd_prev_pd_2 dd_prev_mg_main">'+
                                                    '<label class="pull-left col-sm-4 dd_pd_0 dd_font_left " for="lmpdate">LMP </label>'+
                                            ...
                                            '<div class="">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="pull-left col-sm-4 dd_pd_0 dd_font_left " for="lmpflow">Lmp Flow  '+' '+'</label>'+
                                            ...
                                            '<div class="">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="pull-left col-sm-4 dd_pd_0 dd_font_left " for="lmpdysmenorrhea">Dysmenorrhea '+' '+'</label>'+
                                            ...
                                            '<div class="">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="pull-left col-sm-4 dd_pd_0 dd_font_left " for="days">Days  '+' '+'</label>'+
                                            ...
                                            '<div class="">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="pull-left col-sm-4 dd_pd_0 dd_font_left " for="cycle">Cycle  '+' '+'</label>'+
                                            ...
                                            '<div class="">'+
                                                '<div class="col-sm-12 dd_prev_pd_2">'+
                                                    '<label class="pull-left col-sm-4 dd_pd_0 dd_font_left " for="menstrualtype">Menstrual Type '+' '+'</label>'+
