	  			...
	  			<div class="box_2">
	  				<div class="box_2_main">
	  					...
	  					<div>
	  						...
	  						<div class="box-login " style="display: block;">
	  							...
	  							<div class="row">
	  								<div class="col-sm-12">
	  									{!! Form::open(array('route' => 'handleDoctorAddNewPassword', 'role'=>'form', 'id'=>'new-password', 'class'=>'form-horizontal new-password','name' =>'new-password')) !!}
	  									@if(!empty($doctorData))
	  									{!! Form::hidden('doctor_patient_id',$doctorData->id_doctor,array('placeholder'=>'Password', 'class'=>'form-control dd_input', 'id'=>'id-doctor-patient' ) ) !!}
	  									@endif
                    ...
                    <div class="box_right">
                    	...
                    	<div class="col-sm-12 dd_textalign_center dd_pd_0 dd_dummy dd_font_size_14px">
                    		...
                    		<span class="input-icon ">
                    			<a href="doctorlogin" class="btn btn-primary btn-block dd_btn_new doctor-register-btn"> Register Now</a>
