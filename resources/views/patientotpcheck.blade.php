...
<html lang="en" class="no-js">
	...
	<head>
		...
		<title>Doctor's Diary | Patient Account Activation</title>
		<!-- start: META -->
		<meta charset="utf-8" />
	  ...
	  <!--       <div class="swiper-button-next swiper-button-white"></div>
	        ...
	        <div class="inner_wrapper ">
					<div class="box_2">
			        	...
			        	<div>
			        		<!-- <div class="logo">
			        			<span class="login_HD dd_signfont"></span>
			        		</div> -->
			        		<div class="box-login dd_pading_0" style="display: block;">
			        			<div class="row">
			        			<div class=" col-sm-12 dd_patientregister_hd"> 								                An OTP has sent to your registered mobile. Please specify the OTP in below box 								            </div>
									<div class="col-sm-12">
										<?php 
							     ...
							     <!--      	@if(!empty($error))
							          	...
							          	@endif  -->
			        					{!! Form::open(array('route' => 'handlePatientOtpCheck', 'role'=>'form', 'id'=>'login', 'class'=>'form-horizontal form-login','name' =>'form-login')) !!}
					        				<div class="form-group">
												<div class="col-sm-12 dd_login">
													<span class="input-icon ">
														{!! Form::text('otp_code', null, $attributes = array('class'=>'form-control dd_input','placeholder' => 'OTP Code', 'id'=>'otp_code'));  !!}
					        				...
					        				<!-- <div class="form-group dd_mg_B_10">
					        					<div class="col-sm-12 dd_login">
													<span class="input-icon dd_relative">
														{!! Form::text('mobile', null,  array('placeholder'=>'Mobile', 'class'=>'form-control dd_input', 'id'=>'mobile' ) ) !!}
					        				...
					        				<div class="form-group dd_mg_B_10">
					        					<div class="col-sm-12">
													<p><a href="patientregistercheckid" class="dd_textalign_center"> Activate</a></p>
												</div>
					        				</div> -->
					        				<div class="form-group dd_mg_B_10">
					        					<div class="col-sm-12 dd_mg_B_T_10">
													<span class="input-icon ">
														<button type="submit" class="btn btn-primary btn-block dd_btn">Activate</button>
													</span>
												</div>
											</div>

											<div class=" dd_patientregister_hd_2 ">if you did not get OTP ?<a href="#">Click Here</a> </div>	
