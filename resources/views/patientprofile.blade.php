	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="panel-body">
				{!! Form::open(array('route' => 'handlePatientProfile', 'role'=>'form', 'id'=>'handlePatientProfile', 'class'=>'form-horizontal','novalidate'=>'novalidate','enctype'=>'multipart/form-data')) !!}
...
@section('scripts')
	@parent
		...
		{!!Html::script('assets/js/patient-profile-information.js')!!}
