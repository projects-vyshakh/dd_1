	  			...
	  			<div class="box_2_main">
	  				...
	  				<div>
	  					...
	  					<div class="box-login " style="display: block;">
	  						<div class="row">
	  							<div class="col-sm-12">
	  								{!! Form::open(array('route' => 'handlePatientForgetPassword', 'role'=>'form', 'id'=>'patient-forget-password', 'class'=>'form-horizontal patient-forget-Password','name' =>'patient-forget-Password')) !!}
