			        			...
			        			<div class="row">
									<div class="col-sm-12">
								        ...
								        ?>
							          	...
							          	@endif
			        					{!! Form::open(array('route' => 'handlePatientSetnewPassword', 'role'=>'form', 'id'=>'login', 'class'=>'form-horizontal form-login','name' =>'form-login')) !!}
					        				<div class="form-group">
												<div class="col-sm-12 dd_login">
													{!! Form::label('password', 'Password'); !!}
													<span class="input-icon ">
													<input type="password" name="password" class="form-control dd_input" id="password1">
														<!-- {!! Form::password('password', null, $attributes = array('class'=>'form-control dd_input','placeholder' => 'Password', 'id'=>'password'));  !!} -->
					        				...
					        				<div class="form-group dd_mg_B_10">
					        					<div class="col-sm-12 dd_login">
													...
													<span class="input-icon dd_relative">
														<input type="password" name="cpassword" class="form-control dd_input" id="password2">
														<!-- {!! Form::password('cpassword', null,  array('placeholder'=>'Confirm Password', 'class'=>'form-control dd_input cpassword', 'id'=>'cpassword' ) ) !!} -->
					        				...
					        				<div class="form-group dd_mg_B_10">
					        					<div class="col-sm-12 dd_mg_B_T_10">
													<span class="input-icon ">
														<button type="submit" class="btn btn-primary btn-block dd_btn">Proceed</button>
													</span>
												</div>
											</div>	
