					...
					<div class="box_2">
					 <div class="box_2_main">
			        	...
			        	<div class="dd_logo_responsive">
			        		...
			        		<div class="logo">
			        			<span class="login_HD dd_signfont"> please enter your OTP Number</span>
			        		</div>
                        ...
                        <div class="heading ">
			        		...
			        		<div class="box-login " style="display: block;">
			        			<div class="row">
									<div class="col-sm-12">
			        					{!! Form::open(array('route' => 'handleDoctorOtpCheck', 'role'=>'form', 'id'=>'otp-check', 'class'=>'form-horizontal form-forgot','name' =>'form-forgot')) !!}
					        				<div class="form-group">
												<div class="col-sm-12 dd_login">
													<span class="input-icon ">
														{!! Form::text('otp', null, $attributes = array('class'=>'form-control dd_input','placeholder' => 'OTP', 'id'=>'otp'));  !!}
