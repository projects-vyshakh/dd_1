...
<html lang="en">
  ...
  <body>
	    ...
	    <div id="company">
	        <div>
	        	<h2 class="name" style="margin-bottom: 5px;">Name:<i>@if(!empty($patientName)) {{$patientName}} @else {{""}} @endif </i></h2> 
	        </div>
	        <div><h2 class="name" style="margin-bottom: 5px;" >Age:	<i>@if(!empty($age)) {{$age}} @else {{""}} @endif</i></h2> </div>
	        <div><h2 class="name">Sex:	<i>@if(!empty($gender)) {{$gender}} @else {{""}} @endif</i></h2> </div>
	    </div>
	    ...
	    <div id="details" class="clearfix">
	        <div id="client">
	          ...
	          <div class="address" style="margin-bottom: 5px;">{{$specializationName}}</div>
	    ...
	    @else
	    	<div  class="medical-history" >
	       		...
	       		<h2>Medical History</h2>
	       		<div class="medical-hisotry-inner">
					<div class="column-left">Hypertension: {{"No"}}</div>
				   	<div class="column-center">Diabetes: {{"No"}}</div>
				    <div class="column-right">Cancer: {{"No"}}</div>
				</div>
		    </div>
		    ...
		    <div class="vitals" >
	       		...
	       		<div class="medical-hisotry-inner">
					<div class="vitals-content">
						<img width="40px" height="40px" src="assets/images/weight.png" style="margin-bottom: 8px;">
						<div>{{$weight}} @if(!empty($weight)) {{"Kg"}} @else {{""}} @endif</div>
					</div>
				   	<div class="vitals-content">
				   		<img width="40px" height="40px" src="assets/images/bloodpressure.png" style="margin-bottom: 8px;">
				   		<div>{{$pressure}} @if(!empty($pressure)) {{"mmHg"}} @else {{""}} @endif</div>
				   	</div>
				    <div class="vitals-content">
				    	<img width="40px" height="40px" src="assets/images/pulse.png" style="margin-bottom: 8px;">
				    	<div>{{$pulse}} @if(!empty($pulse)) {{"bpm"}} @else {{""}} @endif</div>
				    </div>
				    <div class="vitals-content">
				    	<img width="40px" height="40px" src="assets/images/respiratoryrate.png" style="margin-bottom: 8px;">
				    	<div>
				    		{{$respiratoryrate}} @if(!empty($respiratoryrate)) {{"breathes/min"}} @else {{""}} @endif
				    	</div>
				    </div>
				    <div class="vitals-content">
				    	<img width="40px" height="40px" src="assets/images/spo2.png" style="margin-bottom: 8px;">
				    	<div>{{$spo2}} @if(!empty($spo2)) {{"%"}} @else {{" "}} @endif</div>
				    </div>
				    <div class="vitals-content">
				    	<img width="40px" height="40px" src="assets/images/temperature.png" style="margin-bottom: 8px;">
		...
		@if(!empty($prescriptionData))
			<div  class="" >
				<div class="treatment-inner-div" style="margin-top: 40px;">
					<h2>Treatment</h2>
					@foreach($prescriptionData as $index=>$prescriptionDataVal)
						<?php 
						...
						?>
					@endforeach
			       	<textarea class="ta6" style="padding: 30px;">{{$treatment}}</textarea>
				</div>
		        <div class="followup-inner-div" style="margin-top: 40px;">
		        	<h2>Followup Date: </h2>
		        	<div>
