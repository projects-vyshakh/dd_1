	        		 		...
	        		 		<div class="logo_div">
								...
								<div class="doctorlogin_main">
									<!-- <span class="doctor_login"><img src="assets/images/doctor_icon.png"></span> -->
										...
										<a href="../doctor/signin" @if($currentPath=="doctor/signin") class="topmenu-active dd_doctor_login"  style="color: #a9f2ff" @endif>Doctor Login</a>&nbsp;  &nbsp;
		        		 		...
		        		 		<div class="patientlogin_main"> 		
		        		 		 	...
		        		 		 	<a href="patientlogin" 
		        		 		 		@if($currentPath=="patient/signin" || 	
		        		 		 		    $currentPath=="patient/signup" || 
		        		 		 		    $currentPath=="patient/registerpassword" ) class="topmenu-active"  style="color: #a9f2ff" @endif>
		        		 		 		Patient Login
		        		 		 	</a>
		        		 		</div>
	        		 		</div>
	  ...
	  <!--       <div class="swiper-button-next swiper-button-white"></div>
	        ...
	        <div class="doctor_login_main">
			        	...
			        	<div class="dd_logo_responsive">
				        	...
				        	<div class="dd_drlogin_responsive">
								...
								<div class="doctorlogin_main2">								
										...
										<a href="../doctor/signin" @if($currentPath=="doctor/signin") class="topmenu-active dd_doctor_login" @endif>Doctor Login</a>&nbsp; / &nbsp;
		        		 		...
		        		 		<div class="patientlogin_main2"> 		
		        		 		 	...
		        		 		 	<a href="patientlogin" 
		        		 		 		@if($currentPath=="patient/signin" || 	
		        		 		 		    $currentPath=="patient/signup" || 
		        		 		 		    $currentPath=="patient/registerpassword") 
					...
					<div class="box_right new_patient_register_otp_div">
						<div class="logo">
			        		<span class="login_HD dd_signfont">Create a new password</span>
			        	</div>
						<div class="box-login " style="display: block;">
		        			<div class="row">
		        				<div class="col-sm-12">
									
		        					{!! Form::open(array('route' => 'handlePatientRegisterPassword', 'role'=>'form', 'id'=>'handlePatientRegisterPassword', 'class'=>'form-horizontal handlePatientRegisterPassword','name' =>'handlePatientRegisterPassword')) !!}
				        				<div class="form-group">
											<div class="col-sm-12 dd_login">
												<span class="input-icon dd_relative">
													{!! Form::password('reg_password', array('placeholder'=>'New Password', 'class'=>'form-control dd_input dd_login_main reg_password', 'id'=>'reg_password' ) ) !!}
													<span class="dd_input_icon"></span>
				        				...
				        				<div class="form-group dd_mg_B_10">
				        					<div class="col-sm-12 dd_login">
												<span class="input-icon dd_relative">
													{!! Form::password('c_password', array('placeholder'=>'Confirm Password', 'class'=>'form-control dd_input dd_login_main c_password', 'id'=>'c_password' ) ) !!}
													<span class="dd_input_icon"></span>
