...
if(!empty($patientData)){
	...
	$time_of_appointment 		= $patientData->time_of_appointment;
...
.dd_tml_40
{
	padding: 34px 30px 40px 32px !important;
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="panel-body">
				{!! Form::open(array('route' => 'addPulmoPersonalInformation', 'role'=>'form', 'id'=>'addPulmoPersonalInformation', 'class'=>'form-horizontal','novalidate'=>'novalidate')) !!}
					...
					<div class="row  dd_color">
						<div class="col-sm-6 dd_PDR_40">
							...
							<div class="form-group dd_fromgroup_MG_0">
								...
								<div class="col-sm-12 dd_PDB_10">
									{!! Form::label('occupation', 'Occupation', $attributes = array('class'=>'col-sm-4 '));  !!}
									<div class="col-sm-8">
										<span class="">
											@if(!empty($occupation))
												{!! Form::text('occupation',$occupation, $attributes = array('class'=>'form-control', 'placeholder' => ''));  !!}
											@else
												{!! Form::text('occupation',Input::old('occupation'), $attributes = array('class'=>'form-control', 'placeholder' => ''));  !!}
											@endif
										</span>
									</div>
								</div>
					...
					<hr class="dd_PDB_40" style="padding-bottom: 0;margin-bottom: 0;">
					<div class="row  dd_color">
						<div class="col-sm-8 dd_tm_40">
							<div class="form-group dd_fromgroup_MG_0 has-success">
								<div class="col-sm-12 dd_tm_10">
								<div class="col-sm-6">
									<span class="input-icon">
					...
					<div class="col-sm-4 dd_tml_40"> 
							<div class="form-group dd_fromgroup_MG_0">
								 <div class="col-sm-12 dd_PDB_10">
									<div class="col-sm-12 bootstrap-timepicker timepicker pull-left">
	
						<span class="input-icon">

							{!! Form::text('time_of_appointment', (!empty($time_of_appointment))?$time_of_appointment:"", $attributes = array('id' => 'timepicker', 'class' => 'form-control dd_phone_from_bg', 'placeholder' => 'Time of appointment')); !!}

	           				
	           				
	            			<i class="fa fa-clock-o" aria-hidden="true" title="Time of appointment"></i>	
						</span>
        			</div>
...
@section('scripts')
	@parent
		...
		{!!Html::script('assets/js/pulmo-personal-information.js')!!}
