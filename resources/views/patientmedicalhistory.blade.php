					...
					<div class="presentPastDiv" id="presentPastDiv">
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name1', 'Hypertension', $attributes = array('class'=>'form-control illness_name_hypertension illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name2', 'Diabetes', $attributes = array('class'=>'form-control illness_name_diabetes illness_name'));  !!}
							</div>
							<!-- Checking  illness existing in the db array -->
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name3', 'Hyperthyroidism', $attributes = array('class'=>'form-control illness_name_hyperthyroidism illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name4', 'Hypothyroidism', $attributes = array('class'=>'form-control illness_name_hypothyroidism illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name5', 'Cyst', $attributes = array('class'=>'form-control illness_name_cyst illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name6', 'Endometriosis', $attributes = array('class'=>'form-control illness_name_endometriosis illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name7', 'Utrine Fibroids', $attributes = array('class'=>'form-control illness_name_uterinefibroids illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name8', 'UTI', $attributes = array('class'=>'form-control illness_name_uti illness_name'));  !!}
							</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('illness_name9', 'Cancer', $attributes = array('class'=>'form-control illness_name_cancer illness_name'));  !!}
							</div>
