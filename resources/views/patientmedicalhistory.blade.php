				...
				<div class="panel-body">
					...
					<div class="presentPastDiv" id="presentPastDiv">
						@if(!empty($medicalHistoryPresentPastMore))
							...
							<div class="form-group">
								<div class="col-sm-2">
									{!! Form::label('cancer', ucfirst($presentPastMore->illness_name), $attributes = array('class'=>''));  !!}	
        ...
        $('#btn-addmore-illness').click(function(e){
            ...
            $('#presentPastDiv').append(
                '<div class="form-group ">'+
                    ...
                    '<div class="dd_col_size">' +
                    '<div class="col-sm-1">' +
                        '<button name="btn-ppmore-remove" onclick="return illnessRemove(this);" class="btn btn-danger btn-ppmore-remove dd_right dd_mg_Medication_10 " id="btn-ppmore-remove">x</button' +
                    '</div>' + 
                    '</div>' +  
                '</div>'    
            );
