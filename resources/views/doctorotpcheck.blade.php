	...
	<html lang="en" class="no-js">
		...
		<head>
			...
			<title>Doctor's Diary | Verify</title>
			<!-- start: META -->
			<meta charset="utf-8" />
					...
					<div class="box_2">
						<div class="box_2_main">
				        	<div>
				        		...
				        		<div class="logo">
				        			<span class="login_HD dd_signfont">Enter your OTP Code.
				        			</span>
				        		</div>
				        		...
				        		<div class="box-login " style="display: block;">
				        			<div class="row">
										<div class="col-sm-12">
				        					{!! Form::open(array('route' => 'handleDoctorForgetOtpCheck', 'role'=>'form', 'id'=>'doctor-otp-check', 'class'=>'form-horizontal doctor-otp-check','name' =>'doctor-otp-check-form')) !!}
						        				<div class="form-group">
													<div class="col-sm-12 dd_login">
														<span class="input-icon ">
															{!! Form::text('doctor_otp', null, $attributes = array('class'=>'form-control dd_input doctor-otp','placeholder' => 'OTP', 'id'=>'doctor-otp','maxlength'=>'4','minlength'=>'4'));  !!}
