					        				...
					        				<div class="form-group">
												<div class="col-sm-12 dd_login">
													<span class="input-icon ">
														{!! Form::text('doctor_otp', null, $attributes = array('class'=>'form-control dd_input doctor-otp','placeholder' => 'OTP', 'id'=>'doctor-otp'));  !!}
				...
				<div class="box_right">
					...
					<div class="col-sm-12 dd_textalign_center dd_pd_0 dd_dummy dd_font_size_14px">
						<span class="input-icon ">
							...
							<a href="doctorsignup" class="btn btn-primary btn-block dd_btn_new doctor-register-btn"> Register Now</a>
						</span>
					</div>
				</div>
