...
if (!empty($medicalHistory))
	{
		foreach ($medicalHistory as $medicalHistoryVal) 
		{
			...
			$otherNotKnown 			= $medicalHistoryVal -> history_other_no;
...
//Other History
if(!empty($othermedicalHistory)){
	$otherNameArray	=	array();
	foreach($othermedicalHistory as $othermedicalHistoryval){
		array_push($otherNameArray, $othermedicalHistoryval->other_history_name);
	}
	
	for($i=0;$i<count($othermedicalHistory);$i++){
		$otherName = $othermedicalHistory[$i]->other_history_name;
		$comments	 = $othermedicalHistory[$i]->other_history_comments;
		$otherDataArray[$otherName]	 =	[$othermedicalHistory[$i]->other_history_status,$othermedicalHistory[$i]->other_history_comments];
	}
}
//Other History
		...
		<div class="col-sm-12">
			...
			<div class="panel">
				...
				<div class="panel-body">
					{!! Form::open(array('route' => 'addPulmoMedicalHistory', 'role'=>'form', 'id'=>'addPulmoMedicalHistory', 'class'=>'form-horizontal','novalidate'=>'novalidate')) !!}
					...
					<div class="presentPastDiv" id="presentPastDiv">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('illness_status3', 'Current','Current' , ['class' => 'present-past-current']) !!} Current </label>
							</div>
							@else
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('illness_status3', 'Current','' , ['class' => 'present-past-current']) !!} Current </label>
							</div>
							@endif
						...
						<div class="form-group">
							...
							@if(in_array('Thyroid',@$illnessNameArray))
								@if($illnessDataArray['Thyroid'][0]=="Current")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status10', 'Current','Current' , ['class' => 'present-past-past']) !!} Current </label>
									</div>
								@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status10', 'Current','' , ['class' => 'present-past-past']) !!} Current </label>
								</div>
								@endif
								@if($illnessDataArray['Thyroid'][0]=="Past")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status10','Past', 'Past', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@else
									<div class="col-sm-2">
								...
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status10','NA','' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@endif
								@if(!empty($illnessDataArray['Thyroid'][1]))
									<div class="col-sm-4">
										{!! Form::text('illness_medication10',$illnessDataArray['Thyroid'][1], $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
									</div>
								@else
									<div class="col-sm-4">
							...
							@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status10', 'Current', null, ['class' => 'present-past-current']) !!}Current </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status10', 'Past', null, ['class' => 'present-past-past']) !!}Past </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status10', 'NA', null, ['class' => 'present-past-na']) !!}N/A </label>
								</div>
								<div class="col-sm-4" >
									{!! Form::text('illness_medication10', Input::old('medication_thyroid'), $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
								</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								{!! Form::label('ihd', 'IHD', $attributes = array('class'=>''));  !!}
								{!! Form::hidden('illness_name11', 'IHD', $attributes = array('class'=>'form-control illness_name_thyroid'));  !!}
							</div>
							@if(in_array('IHD',@$illnessNameArray))
								@if($illnessDataArray['IHD'][0]=="Current")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status11', 'Current','Current' , ['class' => 'present-past-past']) !!} Current </label>
									</div>
								@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status11', 'Current','' , ['class' => 'present-past-past']) !!} Current </label>
								</div>
								@endif
								@if($illnessDataArray['IHD'][0]=="Past")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status11','Past', 'Past', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status11','Past', '', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@endif 
								@if($illnessDataArray['IHD'][0]=="NA")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status11','NA','NA' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status11','NA','' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@endif
								@if(!empty($illnessDataArray['IHD'][1]))
									<div class="col-sm-4">
										{!! Form::text('illness_medication11',$illnessDataArray['IHD'][1], $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
									</div>
								@else
									<div class="col-sm-4">
							...
							@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status11', 'Current', null, ['class' => 'present-past-current']) !!}Current </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status11', 'Past', null, ['class' => 'present-past-past']) !!}Past </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status11', 'NA', null, ['class' => 'present-past-na']) !!}N/A </label>
								</div>
								<div class="col-sm-4" >
									{!! Form::text('illness_medication11', Input::old('medication_ihd'), $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
								</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								{!! Form::label('coad', 'COAD', $attributes = array('class'=>''));  !!}
								{!! Form::hidden('illness_name12', 'COAD', $attributes = array('class'=>'form-control illness_name_coad'));  !!}
							</div>
							@if(in_array('COAD',@$illnessNameArray))
								@if($illnessDataArray['COAD'][0]=="Current")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status12', 'Current','Current' , ['class' => 'present-past-past']) !!} Current </label>
									</div>
								@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status12', 'Current','' , ['class' => 'present-past-past']) !!} Current </label>
								</div>
								@endif
								@if($illnessDataArray['COAD'][0]=="Past")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status12','Past', 'Past', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status12','Past', '', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@endif 
								@if($illnessDataArray['COAD'][0]=="NA")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status12','NA','NA' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status12','NA','' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@endif
								@if(!empty($illnessDataArray['COAD'][1]))
									<div class="col-sm-4">
										{!! Form::text('illness_medication12',$illnessDataArray['COAD'][1], $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
									</div>
								@else
									<div class="col-sm-4">
										{!! Form::text('illness_medication12',Input::old('medication_coad'), $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
									</div>
								@endif
							@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status12', 'Current', null, ['class' => 'present-past-current']) !!}Current </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status12', 'Past', null, ['class' => 'present-past-past']) !!}Past </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status12', 'NA', null, ['class' => 'present-past-na']) !!}N/A </label>
								</div>
								<div class="col-sm-4" >
									{!! Form::text('illness_medication12', Input::old('medication_coat'), $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
								</div>
							@endif
						</div>
						...
						<div class="form-group">
							<div class="col-sm-2">
								{!! Form::label('att', 'ATT', $attributes = array('class'=>''));  !!}
								{!! Form::hidden('illness_name13', 'ATT', $attributes = array('class'=>'form-control illness_name_att'));  !!}
							</div>
							@if(in_array('ATT',@$illnessNameArray))
								@if($illnessDataArray['ATT'][0]=="Current")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status13', 'Current','Current' , ['class' => 'present-past-past']) !!} Current </label>
									</div>
								@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status13', 'Current','' , ['class' => 'present-past-past']) !!} Current </label>
								</div>
								@endif
								@if($illnessDataArray['ATT'][0]=="Past")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status13','Past', 'Past', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status13','Past', '', ['class' => 'present-past-past']) !!}Past </label>
									</div>
								@endif 
								@if($illnessDataArray['ATT'][0]=="NA")
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status13','NA','NA' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@else
									<div class="col-sm-2">
										<label class="radio-inline"> {!! Form::radio('illness_status13','NA','' , ['class' => 'present-past-na']) !!}N/A </label>
									</div>
								@endif
								@if(!empty($illnessDataArray['ATT'][1]))
									<div class="col-sm-4">
										{!! Form::text('illness_medication13',$illnessDataArray['COAD'][1], $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
									</div>
								@else
									<div class="col-sm-4">
							...
							@else
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status13', 'Current', null, ['class' => 'present-past-current']) !!}Current </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status13', 'Past', null, ['class' => 'present-past-past']) !!}Past </label>
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status13', 'NA', null, ['class' => 'present-past-na']) !!}N/A </label>
								</div>
								<div class="col-sm-4" >
									{!! Form::text('illness_medication13', Input::old('medication_att'), $attributes = array('class'=>'form-control present-past-medication-empty','placeholder' => 'Medication'));  !!}
								</div>
						...
						@else
							...
							<div class="form-group">
								<div class="col-sm-2">
									{!! Form::label('ihd', 'IHD', $attributes = array('class'=>''));  !!}
									{!! Form::hidden('illness_name11', 'IHD', $attributes = array('class'=>'form-control illness_name_ihd'));  !!}
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status11', 'Current','' , ['class' => 'present-past-past']) !!} Current </label>
								</div>
							...
							<div class="form-group">
								<div class="col-sm-2">
									{!! Form::label('coat', 'COAD', $attributes = array('class'=>''));  !!}
									{!! Form::hidden('illness_name12', 'COAD', $attributes = array('class'=>'form-control illness_name_coad'));  !!}
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('illness_status12', 'Current','' , ['class' => 'present-past-past']) !!} Current </label>
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							@if(!empty($medicalHistory))
							<textarea name="anaesthesia" class="form-control textarea-anaesthesia" rows="10" cols="40" >{{$anaesthesiaHistory}}</textarea>
								
							@else
								{!! Form::textarea('anaesthesia',null,['class'=>'form-control textarea-anaesthesia', 'rows' => 10, 'cols' => 40]) !!}
					...
					<!-- Other History -->
					<hr>
					{!! Form::hidden('otherHistoryDivCount', "0", $attributes = array('class'=>'form-control other-history-div-count'));  !!}
					<div class="form-group dd_Other_History">
						<div class="col-sm-8">
							<h3>Other History</h3>
						</div>
						@if(!empty($medicalHistory)) 
							@if($otherNotKnown=="NA")
								<div class="col-sm-4  dd_Present_PD">
									<label class="checkbox-inline col-sm-12">
										<input type="checkbox" value="NA" class="noOtherHistory" id="noOtherHistory" checked="checked" />
										<input type="hidden" name="other-check-value" id="other-check-value" class="other-check-value" value="NA"> 
										<span class="dd_past">No known Other history to reports</span>  
									</label>
								</div>
							@else 
								<div class="col-sm-4  dd_Present_PD">
									<label class="checkbox-inline col-sm-12">
										<input type="checkbox" value="" class="noOtherHistory" id="noOtherHistory" />
										<input type="hidden" name="other-check-value" id="other-check-value" class="other-check-value" value=" "> 
										<span class="dd_past">No known Other history to reports</span>  
									</label>
								</div>
							@endif
					...
					<div class="otherHistoryDiv" id="otherHistoryDiv">
						@if(!empty($othermedicalHistory) && !empty($otherNameArray))
						<div class="form-group">
							<div class="col-sm-2">
								{!! Form::label('appetite', 'Appetite', $attributes = array('class'=>''));  !!}
								{!! Form::hidden('other_history_name1', 'Appetite', $attributes = array('class'=>'form-control other_history_name_appetite'));  !!}
							</div> 
							<!-- Checking  illness existing in the db array -->
							@if(in_array('Appetite',$otherNameArray)) 
							@if($otherDataArray['Appetite'][0]=="Normal")
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status1', 'Normal','Normal' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@else
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status1', 'Normal','' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@endif
							
							@if(!empty($otherDataArray['Appetite'][1]))
							<div class="col-sm-4">
								{!! Form::text('other_history_comments1', $otherDataArray['Appetite'][1], $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@else
							<div class="col-sm-4">
								{!! Form::text('other_history_comments1', Input::old('comments_appetite'), $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@endif
							@else
							<div class="col-sm-2">
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('other_history_name2', 'Sleep', $attributes = array('class'=>'form-control other_history_name_sleep'));  !!}
							</div> 
							<!-- Checking  illness existing in the db array -->
							@if(in_array('Sleep',$otherNameArray)) 
							@if($otherDataArray['Sleep'][0]=="Normal")
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status2', 'Normal','Normal' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@else
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status2', 'Normal','' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@endif
							
							@if(!empty($otherDataArray['Sleep'][1]))
							<div class="col-sm-4">
								{!! Form::text('other_history_comments2', $otherDataArray['Sleep'][1], $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@else
							<div class="col-sm-4">
								{!! Form::text('other_history_comments2', Input::old('comments_sleep'), $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@endif
							@else
							<div class="col-sm-2">
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('other_history_name3', 'Stool', $attributes = array('class'=>'form-control other_history_name_stool'));  !!}
							</div> 
							<!-- Checking  illness existing in the db array -->
							@if(in_array('Stool',$otherNameArray)) 
							@if($otherDataArray['Stool'][0]=="Normal")
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status3', 'Normal','Normal' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@else
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status3', 'Normal','' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@endif
							
							@if(!empty($otherDataArray['Stool'][1]))
							<div class="col-sm-4">
								{!! Form::text('other_history_comments3', $otherDataArray['Stool'][1], $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@else
							<div class="col-sm-4">
								{!! Form::text('other_history_comments3', Input::old('comments_stool'), $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@endif
							@else
							<div class="col-sm-2">
						...
						<div class="form-group">
							<div class="col-sm-2">
								...
								{!! Form::hidden('other_history_name4', 'Urine', $attributes = array('class'=>'form-control other_history_name_urine'));  !!}
							</div> 
							<!-- Checking  illness existing in the db array -->
							@if(in_array('Urine',$otherNameArray)) 
							@if($otherDataArray['Urine'][0]=="Normal")
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status4', 'Normal','Normal' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@else
							<div class="col-sm-2">
								<label class="radio-inline"> {!! Form::radio('other_history_status4', 'Normal','' , ['class' => 'other-history-normal']) !!} Normal </label>
							</div>
							@endif
							
							@if(!empty($otherDataArray['Urine'][1]))
							<div class="col-sm-4">
								{!! Form::text('other_history_comments4', $otherDataArray['Urine'][1], $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@else
							<div class="col-sm-4">
								{!! Form::text('other_history_comments4', Input::old('comments_urine'), $attributes = array('class'=>'form-control other-history-comments-empty comments'));  !!}
							</div>
							@endif
							@else
							<div class="col-sm-2">
						...
						@foreach($othermedicalHistory as $othermedicalHistoryVal)
							<?php
								$otherHistoryName 		= $othermedicalHistoryVal->other_history_name;
								$otherHistoryStatus		= $othermedicalHistoryVal->other_history_status;
								$otherHistoryComments	= $othermedicalHistoryVal->other_history_comments;
							
							?>
							@if($otherHistoryName=="Appetite" || 
								$otherHistoryName=="Sleep" || 
								$otherHistoryName=="Stool"	 || 
								$otherHistoryName=="Urine" )
							
							@else	
								@if(!empty($illnessName))
									<div class="form-group">
										<div class="col-sm-2">
											<label>{{ucfirst($otherHistoryName)}}</label>
											<input type="hidden" name="otherHistoryName{{$counter}}" value="{{$otherHistoryName}}" class="other_history_name" />
										</div> 
										
										@if($otherHistoryStatus=="Normal")
										
											<div class="col-sm-2">
												<label class="radio-inline">
													<input type="radio" class="other-history-normal" name="other_history_status{{$counter}}" value="Normal" checked="checked" id="normal{{$counter}}"/>Normal
												</label>
											</div>
										@else
											<div class="col-sm-2">
												<label class="radio-inline">
													<input type="radio" class="other-history-normal" name="other_history_status{{$counter}}" value="Normal"  id="normal{{$counter}}"/>Normal
												</label>
											</div>
										@endif
										...
										<div class="col-sm-4" >
											<input type="text" name="other_history_comments{{$counter}}"	value="{{$otherHistoryComments}}" class="form-control other-history-comments-empty"/>
										</div>
						...
						@else
							...
							<div class="form-group">
								<div class="col-sm-2">
									{!! Form::label('urine', 'Urine', $attributes = array('class'=>''));  !!}
									{!! Form::hidden('other_history_name4', 'Urine', $attributes = array('class'=>'form-control other_history_name_stool'));  !!}
								</div>
								<div class="col-sm-2">
									<label class="radio-inline"> {!! Form::radio('other_history_status4', 'Normal','' , ['class' => 'other-history-normal']) !!} Normal </label>
								</div>
					...
					<div class="form-group">
						<div class="col-sm-12">
							<button type="submit" class="btn btn-default btn-addmore-illness pull-right" id="btn-addmore-others" style="margin-top: 10px">
								<i class="fa fa-plus-circle "></i> Add More History
							</button>
						</div>
					</div>
							...
							@if(!empty($patientPersonalData))
								<div class="form-group">
									...
									<div class="col-sm-12">
										<button type="submit" class="btn btn-primary btn-block btn-medical-save dd_save "><!-- <i class="fa fa-floppy-o"></i> --> Save</button>
									</div>
								</div>
							@else
								<div class="form-group">
									<div class="col-sm-10"></div>
									<div class="col-sm-12">
										<button type="submit" class="btn btn-primary btn-block btn-medical-save dd_save " disabled="disabled"><!-- <i class="fa fa-floppy-o"></i> --> Save
										</button>
									</div>
								</div>
							@endif
...
@section('scripts')
	@parent
		...
		{!!Html::script('assets/js/pulmo-medical-history.js')!!}
	...
	<script>
		$(document).ready(function() {
			...
			pulmoMedicalHistoryElements.init();
	
   			var presentPastDivCount = $('.presentPastDiv').find('.form-group').length;
   			$('.present-past-div-count').val(presentPastDivCount);
   			var OtherHistoryDivCount = $('.otherHistoryDiv').find('.form-group').length;
   			$('.other-history-div-count').val(OtherHistoryDivCount);
		});
    	...
    	function otherRemove(e){
       
            var clickedElements = $(e).closest('.form-group');
            //console.log(clickedElements);
            

            var removedRawId = clickedElements.find('.other-history-comments-empty').attr('id');
            clickedElements.remove();   

            var removedId = parseInt(removedRawId.replace(/[^0-9\.]/g, ''), 10);
            //console.log(removedId);

            $('.otherHistoryDiv').each(function(){
                    var defaultOtherCount = $(this).find('.form-group').length;
                    $('.other-history-div-count').val(defaultOtherCount);
            });

            var newDefaultOtherCount = $('.other-history-div-count').val();
            //console.log(newDefaultIllnessCount);

            for(i=1;i<=newDefaultOtherCount;i++){
                
                var nextOtherId = parseInt(i) + parseInt(1);
                if(nextOtherId>removedId){
                    var decrementOtherId = nextOtherId - 1;
                    console.log('decrement'+decrementOtherId);
                    var selected1 = $('#otherHistoryDiv').find('.form-group').find('#other_history_name'+nextOtherId);
                    var selected2 = $('#otherHistoryDiv').find('.form-group').find('#other_history_status_normal'+nextOtherId);
                    var selected3 = $('#otherHistoryDiv').find('.form-group').find('#comments_other_history'+nextOtherId);
                    //var selected2 = $('#medicine').find('.form-group').find('.frequency'+nextDivId);
                    //selected1.attr('name','frequency'+decrementDivId+'[]');
                    selected1.attr({
                          'name' : 'other_history_name'+decrementOtherId,
                          'id': 'other_history_name'+decrementOtherId
                    });
                    selected2.attr({
                          'name' : 'other_history_status'+decrementOtherId,
                          'id': 'other_history_status_normal'+decrementOtherId
                    });
                    

                    selected3.attr({
                          'name' : 'other_history_comments'+decrementOtherId,
                          'id': 'comments_other_history'+decrementOtherId
                    });
                    
                    
                }
                
                $('.other-history-div-count').val(newDefaultOtherCount	);
    	...
    	$('.other-history-normal').click(function() {
    		console.log('clicked');
