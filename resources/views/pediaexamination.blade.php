			...
			{!! Form::open(array('route' => 'addPediaExamination', 'role'=>'form', 'id'=>'addPediaExamination', 'class'=>'form-horizontal','novalidate'=>'novalidate')) !!}
				...
				@if(!empty($vitalExist))
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<span>
							{!! Form::textarea('vaccination_history',  $vitalExist->vaccination_history, $attributes = array('class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"));  !!}
							</span>
						</div>
						</div>
						<div class="form-group">
						...
						<div class="col-sm-10">
						<span>
						{!! Form::textarea('significant_history',  $vitalExist->significant_history, $attributes = array('class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"));  !!}
						</span>
						</div>
						</div>
				@else
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<span>
							{!! Form::textarea('vaccination_history','', $attributes = array('class'=>'form-control textarea-comments', 'rows' =>4, 'cols' => 40,'placeholder'=>"Comments"));  !!}
							</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<span>
							{!! Form::textarea('significant_history','', $attributes = array('class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"));  !!}
							</span>
						</div>
					</div>
				@endif
				...
				@if(!empty($pediatricExamData))
					<div class="form-group">
						<div class="col-sm-8">
				<h3 class="dd_h3_Pd_t_0">SKIN & NAILS</h3>
			</div>
					</div>
					<!-- <div class="form-group">
					...
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
								{!! Form::textarea('skin_remarks',$pediatricExamData->skin_remarks,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
				<hr>
					...
					<div class="form-group">
						{!! Form::label('ent_remarks', 'Remarks', $attributes = array('class'=>"col-sm-2"));  !!}
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('ent_remarks',$pediatricExamData->ent_remarks,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<hr>
				...
				<h3 class="dd_h3_Pd_t_0">EYE CHECKUP</h3>
						...
						<div class="form-group">
							{!! Form::label('eye_remarks', 'Remarks', $attributes = array('class'=>"col-sm-2"));  !!}
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('eye_remarks',$pediatricExamData->eye_remarks,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<hr>
...
<div class="col-sm-6 dd_Plaque_pd_0">
			...
			<div class="col-sm-2">
					 <label>E</label>
					 <input type="checkbox" value="upperleft1"  class="teeths" id="teeths" name="upperleft[]" @if(in_array("upperleft1",$upper_left)) checked="checked" @endif>
					 </div>
					 <div class="col-sm-2">
					 <label>B</label>
					 <input type="checkbox" value="upperleft2"  class="teeths" id="teeths" name="upperleft[]" @if(in_array("upperleft2",$upper_left)) checked="checked" @endif >
					 </div>
					 <div class="col-sm-2">
					 <label>C</label>
					 <input type="checkbox" value="upperleft3"  class="teeths" id="teeths" name="upperleft[]" @if(in_array("upperleft3",$upper_left)) checked="checked" @endif >
					 </div>
					 <div class="col-sm-2">
					 <label>D</label>
					 <input type="checkbox" value="upperleft4"  class="teeths" id="teeths" name="upperleft[]" @if(in_array("upperleft4",$upper_left)) checked="checked" @endif >
					 </div>
					 <div class="col-sm-2">
					 <label>E</label>
					 <input type="checkbox" value="upperleft5"  class="teeths" id="teeths" name="upperleft[]" @if(in_array("upperleft5",$upper_left)) checked="checked" @endif >
					 </div>
					 </div>
					 </div>
					 </div>
										...
										<div class="col-sm-2">
					 <label>A</label>
					 <input type="checkbox" value="upperleft1" id="teeths" class="teeths" name="upperleft[]">
					 </div>
					 <div class="col-sm-2">
					 <label>B</label>
					 <input type="checkbox" value="upperleft2" id="teeths" class="teeths" name="upperleft[]">
					 </div>
					 <div class="col-sm-2">
					 <label>C</label>
					 <input type="checkbox" value="upperleft3" id="teeths" class="teeths" name="upperleft[]">
					 </div>
					 <div class="col-sm-2">
					 <label>D</label>
					 <input type="checkbox" value="upperleft4" id="teeths" class="teeths" name="upperleft[]">
					 </div>
					 <div class="col-sm-2">
					 <label>E</label>
					 <input type="checkbox" value="upperleft5" id="teeths" class="teeths" name="upperleft[]">
					 </div>
			...
			<div class="col-sm-2">
					 <label>A</label>
					 <input type="checkbox" value="upperright1"  class="teeths" id="teeths" name="upperright[]" @if(in_array("upperright1",$upper_right)) checked="checked" @endif>
					 </div>
					 <div class="col-sm-2">
					 <label>B</label>
					 <input type="checkbox" value="upperright2"  class="teeths" id="teeths" name="upperright[]" @if(in_array("upperright2",$upper_right)) checked="checked" @endif >
					 </div>
					 <div class="col-sm-2">
					 <label>C</label>
					 <input type="checkbox" value="upperright3"  class="teeths" id="teeths" name="upperright[]" @if(in_array("upperright3",$upper_right)) checked="checked" @endif >
					 </div>
					 <div class="col-sm-2">
					 <label>D</label>
					 <input type="checkbox" value="upperright4"  class="teeths" id="teeths" name="upperright[]" @if(in_array("upperright4",$upper_right)) checked="checked" @endif >
					 </div>
					 <div class="col-sm-2">
					 <label>E</label>
					 <input type="checkbox" value="upperright5"  class="teeths" id="teeths" name="upperright[]" @if(in_array("upperright5",$upper_right)) checked="checked" @endif >
					 </div>
					 </div>
					 </div>
					 </div>
					...
					<div class="panel-hide">
									...
									<div class="panel panel-default panel_me">
										...
										<div class="row">
											<div class="col-sm-12">
												<div class="form-group">
												<div class="col-sm-2">
												 <input type="checkbox" value="lowerleft1" id="teeths" class="teeths" name="lowerleft[]" @if(in_array("lowerleft1",$lower_left)) checked="checked" @endif>
												 <label>E</label>
												</div>
												<div class="col-sm-2">
												 <input type="checkbox" value="lowerleft2" id="teeths" class="teeths" name="lowerleft[]" @if(in_array("lowerleft2",$lower_left)) checked="checked" @endif>
												  <label>D</label>
												</div>
												<div class="col-sm-2">
												 <input type="checkbox" value="lowerleft3" id="teeths" class="teeths" name="lowerleft[]" @if(in_array("lowerleft3",$lower_left)) checked="checked" @endif>
												  <label>C</label>
												</div>
												<div class="col-sm-2">
												 <input type="checkbox" value="lowerleft4" id="teeths" class="teeths" name="lowerleft[]" @if(in_array("lowerleft4",$lower_left)) checked="checked" @endif>
												  <label>B</label>
												</div>
												<div class="col-sm-2">
												 <input type="checkbox" value="lowerleft5" id="teeths" class="teeths" name="lowerleft[]" @if(in_array("lowerleft5",$lower_left)) checked="checked" @endif>
												  <label>A</label>
												</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
							<span>
							{!! Form::textarea('dental_tongue',$pediatricExamData->dental_tongue,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
					...
					<div class="form-group">
							...
							<div class="col-sm-10">
							<span>
							{!! Form::textarea('dental_remarks',$pediatricExamData->dental_remarks,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<hr>
				...
				<h3 class="dd_h3_Pd_t_0">SYSTEMIC EXAMINATON</h3>
						...
						<div class="form-group">
							{!! Form::label('cvs', 'CVS', $attributes = array('class'=>"col-sm-2"));  !!}
							<div class="col-sm-10">
							<span>
							{!! Form::textarea('systemic_examination_tongue',$pediatricExamData->systemic_tongue,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
								{!! Form::textarea('systemic_examination_chest',$pediatricExamData->systemic_chest,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
								{!! Form::textarea('systemic_examination_pa',$pediatricExamData->systemic_pa,['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
				...
				<h3 class="dd_h3_Pd_t_0">SKIN & NAILS</h3>
					...
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('skin_remarks','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
				...
				<h3 class="dd_h3_Pd_t_0">ENT CHECKUP</h3>
						...
						{!! Form::label('ent_remarks', 'Remarks', $attributes = array('class'=>"col-sm-2"));  !!}
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('ent_remarks','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<hr>
				...
				<h3 class="dd_h3_Pd_t_0">EYE CHECKUP</h3>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('eye_remarks','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<hr>
				...
				<h3 class="dd_h3_Pd_t_0">DENTAL CHECKUP</h3>
									...
									<div class="panel panel-default panel_me">
										...
										Form::checkbox('upperright[]', 'upperright1',false,array('class' => 'teeths','id' => 'teeths'));  !!}
												...
												<div class="col-sm-2">
												 <label>B</label>
												{!!
										Form::checkbox('upperright[]', 'upperright2',false,array('class' => 'teeths','id' => 'teeths'));  !!}
												</div>
												<div class="col-sm-2">
												 <label>C</label>
												{!!
					...
					<div class="panel-hide">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('dental_tongue','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
							{!! Form::textarea('dental_remarks','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<hr>
				...
				<h3 class="dd_h3_Pd_t_0">SYSTEMIC EXAMINATON</h3>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
							<span>
								{!! Form::textarea('systemic_examination_tongue','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
								{!! Form::textarea('systemic_examination_chest','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					<div class="form-group">
							...
							<div class="col-sm-10">
								<span>
								{!! Form::textarea('systemic_examination_pa','',['class'=>'form-control textarea-comments', 'rows' => 4, 'cols' => 40,'placeholder'=>"Comments"]) !!}
							</span>
							</div>
					</div>
					@endif
