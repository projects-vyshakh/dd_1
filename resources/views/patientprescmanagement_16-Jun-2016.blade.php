					...
					@else
						<div class="form-group">
							<div class="dd_col">
								...
								<div class="col-sm-8">
									<span>
										{!! Form::text('presc_exercise_other',null,['class'=>'form-control','placeholder'=>'Other']) !!}
									</span>
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								...
								<div class="col-sm-8">
									<span>
										{!! Form::text('presc_diet_other',null,['class'=>'form-control','placeholder'=>'Other']) !!}
									</span>
								</div>
							</div>
						</div>
