											...
											@foreach($prescMedicine as $index => $prescMedicineVal)
												...
												?>
													...
													<div class="col-sm-2">
														...
														{!! Form::text('start_date[]',$startDate , $attributes = array('class'=>'form-control  date-picker','placeholder' => 'Start Date','data-date-viewmode'=>'years','data-date-format'=>'dd-mm-yyyy' ));  !!}
	   		...
	   		$('.btn-add-drug').click(function(e){
	   			...
	   			$('#medicine').append('<div class="drugDynamic">'+
										...
										'<div class="dd_top_mt dd_rs_mg"></div>'+
											'<Input type="text" name="drugs_dynamic[]" class="form-control drugs" placeholder="Drugs" id="drug">'+
										'</div>' +
										'<div class="col-sm-2">' +
										'<div class="dd_top_mt dd_rs_mg"></div>'+
											'<Input type="text" name="dosage_dynamic[]" class="form-control "'+'placeholder="Dosage" >'+ 
										'</div>' +
									
										'<div class="col-sm-2">' + 
										'<div class="dd_top_mt dd_rs_mg"></div>'+
											'<Input type="text" name="start_date_dynamic[]" class="form-control date-picker" placeholder="Start Date"data-date-viewmode="years" data-date-format="dd-mm-yyyy">'+
										'</div>' +
										'<div class="col-sm-2">' +
										'<div class="dd_top_mt dd_rs_mg"></div>'+
											'<Input type="text" name="duration_dynamic[]" class="form-control "'+'placeholder="Duration" >'+ 
										'</div>' +
										'<div class="col-sm-2">' +
										'<div class="dd_top_mt dd_rs_mg"></div>'+
											'<div class="frequencyDiv">'+
											'<select name="frequency_dynamic'+counter+'[]" class="form-control search-select frequency" id="frequency'+counter+'"  multiple ="multiple">' +
												'</select>'	+
											'</div>'+	
										'</div>' +
										'<div class="col-sm-2">' +
											'<button name="btn-drugmore-remove" class="btn btn-danger btn-drugmore-remove  dd_medicine_remove pull-right" id="btn-drugmore-remove'+counter+'">Remove</button' +
										'</div>' +
										'</div>' +
