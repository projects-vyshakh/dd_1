                ...
                <div class="container dd_pd_0">
                    <div class="row dd_mg_0">
                        <div class="col-sm-12 dd_pd_0">
                            <div class="logo_div">
                                <a class="navbar-brand dd_logo_img dd_logo_img" href="login">
       ...
       <!-- Swiper -->
        <div class="swiper-container dd_bg_black">
            ...
            <div class="swiper-wrapper dd_swiper_opacity  "><!--  -->
                ...
                <div class="swiper-slide" style="background-image:url(assets/images/slider4.jpeg) "></div>
            </div>
        ...
        <div class="inner_wrapper">
            ...
            <div class="box_admin">
                <div class="row dd_pd_LR_20">
                    ...
                    <div class=" core-box dd_margin_0 dd_width_90 dd_border_0">
                        <div class="heading">
                ...
                <div class="row dd_padding_lr">
                    <div class="col-sm-6 dd_border_right dd_patient_pd_L">
                        <div class="row">
                            <div class="col-sm-12 dd_upper">New Patient </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-sm-6 dd_patient_pd_R">
                        <div class="row">
                            <div class="col-sm-12 dd_upper">Old Patient </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 dd_upper_2">Enter Old Patient Id </div>
                        </div>
                        <div class="core-box dd_width_90 dd_border_0">
                            <div class="content"></div>
